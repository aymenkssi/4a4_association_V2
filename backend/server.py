...
DEFAULT_PAGES: Dict[str, PageContent] = {
    ...
    "charte-enfants": PageContent(
        fr={
            "title": "Charte de respect et de protection des enfants",
            "body": "Grandir, apprendre et s'épanouir ensemble — Association 4 à 4 dix-huit\n\nNotre engagement auprès des enfants\n\nDans notre association, nous avons la chance d'accompagner des enfants de 3 à 12 ans pour des activités artistiques, culturelles et sportives.\n\nChaque enfant arrive avec son histoire, sa personnalité, ses émotions, ses envies et ses fragilités. Notre rôle est de lui offrir un espace dans lequel il puisse découvrir, expérimenter, apprendre, jouer, créer et prendre confiance, tout en se sentant pleinement en sécurité.\n\nCette sécurité est une responsabilité collective. Elle concerne les intervenants, les bénévoles, les adhérents et toutes les personnes qui participent à la vie de l'association.\n\nCette charte nous rappelle les valeurs et les attitudes que nous souhaitons partager pour que chaque enfant trouve chez nous un environnement respectueux, bienveillant et sécurisant.\n\n1. Chaque enfant mérite le respect\n\nNous accueillons chaque enfant tel qu'il est. Nous respectons : son corps ; ses émotions ; son rythme ; sa personnalité ; ses différences ; ses capacités et ses difficultés ; sa parole et ses limites.\n\nUn enfant a le droit de se tromper, de recommencer, de ne pas réussir du premier coup, d'être parfois en colère, triste, timide ou enthousiaste. Nous accompagnons l'enfant sans le rabaisser.\n\nNous pouvons poser des règles et des limites. Elles sont nécessaires à la vie du groupe. Mais nous les posons avec respect. Faire respecter une règle ne nécessite jamais d'humilier un enfant.\n\n2. Nous prenons soin du corps des enfants\n\nLe corps de l'enfant lui appartient. Aucun adulte ne doit faire subir à un enfant un geste violent, brutal ou humiliant. Nous ne frappons pas, nous ne secouons pas, nous ne poussons pas volontairement et nous n'utilisons jamais la force physique pour punir ou faire obéir.\n\nDans certaines activités, notamment sportives ou artistiques, le contact physique peut être nécessaire. Dans ce cas, nous nous demandons toujours : Est-ce nécessaire ? Est-ce adapté ? Est-ce respectueux ? Est-ce que l'enfant se sent à l'aise ?\n\nNous privilégions toujours l'explication, la parole et l'accompagnement.\n\n3. Respecter les limites de l'enfant\n\nUn enfant peut aimer les câlins, le contact physique ou les marques d'affection. Un autre peut ne pas les apprécier. Les deux sont parfaitement légitimes. Nous respectons le « non », le recul, le refus ou le malaise d'un enfant.\n\nNous ne forçons jamais un enfant à : faire un câlin ; embrasser quelqu'un ; s'asseoir sur les genoux d'un adulte ; accepter un contact physique ; participer à une activité s'il exprime un refus ou un malaise.\n\nDe la même manière, l'adulte reste attentif à sa propre posture et veille à maintenir une relation adaptée à son rôle. Il peut rassurer un jeune enfant tout en maintenant une distance physique (poser sa main sur l'épaule, parler face à l'enfant à voix douce et à sa hauteur).\n\nLa confiance avec un enfant se construit par le respect, jamais par la contrainte.\n\n4. Nos activités doivent rester des espaces de plaisir\n\nQu'il s'agisse de sport, de musique, de théâtre, d'arts plastiques, de culture ou de toute autre activité, l'enfant doit pouvoir y trouver du plaisir et le sentiment de progresser.\n\nNous encourageons les enfants. Nous valorisons leurs efforts. Nous avons le droit de leur demander de recommencer, de se concentrer, de respecter une consigne ou de faire un effort. Mais nous évitons les paroles qui blessent, humilient ou étiquettent.\n\nNous ne voulons pas entendre : « Tu es nul. » « Tu ne comprends jamais rien. » « Regarde comme les autres sont meilleurs que toi. » « Si tu continues, tu vas le regretter. »\n\nMais : « Essaie encore. » « On va chercher une autre manière de faire. » « Je vois que tu as des difficultés, comment puis-je t'aider ? » « Cette règle est importante, je vais t'expliquer pourquoi. »\n\nNous cherchons à faire grandir l'enfant, pas à le faire obéir par la peur, ni à le dresser.\n\n5. Une vigilance particulière dans certaines situations\n\nÊtre bienveillant, c'est aussi savoir être vigilant. Certaines situations demandent une attention particulière : être seul avec un enfant, accompagner un enfant aux toilettes, intervenir dans un vestiaire, aider un enfant qui se blesse, transporter des enfants ou échanger avec eux en dehors des activités.\n\nDans ces situations, nous veillons toujours à : respecter l'intimité de l'enfant ; rester dans le cadre de notre rôle ; éviter les situations d'isolement lorsqu'elles ne sont pas nécessaires ; privilégier les espaces visibles et connus des autres adultes ; ne faire que ce qui est nécessaire pour aider l'enfant ; informer un responsable lorsque la situation le nécessite.\n\nLa transparence nous protège tous, et protège avant tout les enfants.\n\n6. Une relation adaptée, y compris en dehors des activités\n\nLes enfants peuvent beaucoup s'attacher aux adultes qui les accompagnent. Cette confiance est précieuse. Elle implique aussi que l'adulte garde une juste distance.\n\nLes relations personnelles ou les échanges privés avec les enfants ne doivent pas sortir du cadre de l'association. Les communications doivent rester liées aux activités et utiliser, autant que possible, les moyens de communication prévus par l'association.\n\nPas de photos et vidéos d'enfants sans autorisation de l'association, qui veillera à respecter les règles de droit à l'image.\n\n7. Quand un enfant nous parle, nous l'écoutons\n\nParfois, un enfant nous confie quelque chose d'important. Il peut parler directement. Mais il peut aussi exprimer son malaise par son comportement, son silence, ses pleurs, sa peur ou un changement soudain d'attitude. Nous ne cherchons pas à minimiser ce qu'il ressent. Nous l'écoutons calmement.\n\nNous ne lui disons pas : « Ce n'est rien. » « Tu exagères. » « Oublie ça. »\n\nNous pouvons lui dire : « Je t'écoute. » « Tu as bien fait de m'en parler. » « Je vais chercher de l'aide pour savoir quoi faire. »\n\nNous ne promettons jamais à un enfant de garder pour nous une information qui pourrait concerner sa sécurité.\n\n8. En cas de doute, nous en parlons\n\nNous n'avons pas besoin d'être certains qu'une situation est grave pour en parler : un geste qui nous met mal à l'aise, une attitude qui nous interroge, un enfant qui semble avoir peur, des propos inhabituels, un comportement d'adulte qui nous paraît inapproprié.\n\nUn doute mérite d'être partagé. Nous en parlons au responsable ou au référent désigné par l'association. Nous ne cherchons pas nous-mêmes à enquêter ou à faire parler l'enfant davantage. Notre premier rôle est de protéger et d'alerter.\n\n9. Nous sommes tous responsables\n\nLa protection des enfants n'est pas seulement l'affaire des professionnels. Un bénévole peut voir quelque chose. Un intervenant peut entendre une parole. Un adhérent peut être témoin d'une situation. Chacun peut contribuer à créer un environnement plus sûr.\n\nCela signifie aussi que nous pouvons nous parler entre adultes lorsqu'une situation nous questionne. Signaler un comportement qui nous semble inadapté n'est pas accuser quelqu'un. C'est contribuer à la protection des enfants et au bon fonctionnement de notre association.\n\n10. L'esprit de notre association\n\nNous voulons que les enfants qui franchissent notre porte puissent repartir en ayant vécu une expérience positive. Nous voulons qu'ils puissent : oser essayer, oser se tromper, oser poser des questions, oser dire non, oser demander de l'aide, oser être eux-mêmes.\n\nNous voulons que chaque enfant puisse rencontrer des adultes qui savent poser un cadre tout en restant à l'écoute. Des adultes qui transmettent leur passion, des adultes qui encouragent, des adultes qui savent reconnaître leurs propres limites, des adultes en qui les enfants peuvent avoir confiance.\n\nNotre engagement\n\nEn faisant partie de l'association, nous contribuons tous à créer cet environnement. Nous nous engageons à :\n\nRESPECTER chaque enfant et son intégrité.\nÉCOUTER sa parole et prendre ses émotions au sérieux.\nPROTÉGER son corps et son intimité.\nENCOURAGER sans humilier ni comparer.\nPOSER DES LIMITES sans violence ni peur.\nRESTER VIGILANTS face aux situations qui pourraient mettre un enfant en difficulté.\nPARLER lorsqu'une situation nous questionne.\nAGIR lorsque la sécurité ou le bien-être d'un enfant est en jeu.\n\nParce qu'au-delà de nos activités, de nos ateliers et de nos projets, nous avons une responsabilité essentielle : faire en sorte que chaque enfant se sente respecté, écouté et en sécurité.",
        },
        en={
            "title": "Child Respect and Protection Charter",
            "body": 'Growing, learning and flourishing together — Association 4 à 4 dix-huit\n\nOur commitment to children\n\nIn our association, we have the privilege of supporting children aged 3 to 12 in artistic, cultural and sports activities.\n\nEvery child comes with their own story, personality, emotions, wishes and vulnerabilities. Our role is to offer them a space where they can discover, experiment, learn, play, create and gain confidence, while feeling fully safe.\n\nThis safety is a collective responsibility. It concerns the facilitators, volunteers, members and everyone who takes part in the association\'s life.\n\nThis charter reminds us of the values and attitudes we want to share so that every child finds a respectful, caring and secure environment with us.\n\n1. Every child deserves respect\n\nWe welcome every child as they are. We respect: their body; their emotions; their pace; their personality; their differences; their abilities and difficulties; their voice and their limits.\n\nA child has the right to make mistakes, to try again, to not succeed on the first try, to sometimes be angry, sad, shy or enthusiastic. We support the child without belittling them.\n\nWe may set rules and limits. They are necessary for group life. But we set them with respect. Enforcing a rule never requires humiliating a child.\n\n2. We take care of children\'s bodies\n\nA child\'s body belongs to them. No adult should subject a child to a violent, brutal or humiliating act. We do not hit, shake or push children on purpose, and we never use physical force to punish or to make a child obey.\n\nIn certain activities, particularly sports or artistic ones, physical contact may be necessary. In that case, we always ask ourselves: Is it necessary? Is it appropriate? Is it respectful? Does the child feel comfortable?\n\nWe always favor explanation, dialogue and guidance.\n\n3. Respecting the child\'s limits\n\nSome children enjoy hugs, physical contact or displays of affection. Others do not. Both are entirely legitimate. We respect a child\'s "no", their withdrawal, refusal or discomfort.\n\nWe never force a child to: give a hug; kiss someone; sit on an adult\'s lap; accept physical contact; take part in an activity if they express refusal or discomfort.\n\nLikewise, the adult remains mindful of their own posture and ensures a relationship suited to their role, reassuring a young child while keeping an appropriate physical distance (a hand on the shoulder, speaking gently and at the child\'s eye level).\n\nTrust with a child is built through respect, never through coercion.\n\n4. Our activities must remain spaces of enjoyment\n\nWhether in sport, music, theatre, visual arts, culture or any other activity, the child should be able to find enjoyment and a sense of progress there.\n\nWe encourage children. We value their efforts. We may ask them to try again, to concentrate, to follow an instruction or to make an effort. But we avoid words that hurt, humiliate or label.\n\nWe do not want to hear: "You\'re useless." "You never understand anything." "Look how much better the others are than you." "If you keep this up, you\'ll regret it."\n\nInstead: "Try again." "Let\'s find another way to do it." "I can see you\'re struggling, how can I help?" "This rule matters, let me explain why."\n\nWe seek to help the child grow, not to make them obey out of fear, nor to break their will.\n\n5. Particular vigilance in certain situations\n\nBeing caring also means being vigilant. Some situations call for particular attention: being alone with a child, taking a child to the toilet, stepping into a changing room, helping an injured child, transporting children, or talking with them outside of activities.\n\nIn these situations, we always make sure to: respect the child\'s privacy; stay within the scope of our role; avoid isolation when it is not necessary; favor spaces that are visible and known to other adults; do only what is necessary to help the child; inform a supervisor when the situation requires it.\n\nTransparency protects all of us, and above all protects children.\n\n6. An appropriate relationship, including outside of activities\n\nChildren can grow very attached to the adults who work with them. This trust is precious. It also means the adult must maintain a fair distance.\n\nPersonal relationships or private exchanges with children must not go beyond the scope of the association. Communications should remain linked to activities and use, as much as possible, the communication channels provided by the association.\n\nNo photos or videos of children without the association\'s authorization, which will ensure image rights are respected.\n\n7. When a child speaks to us, we listen\n\nSometimes a child shares something important with us. They may say it directly. But they may also express discomfort through their behavior, silence, tears, fear or a sudden change in attitude. We do not try to minimize what they feel. We listen calmly.\n\nWe do not say: "It\'s nothing." "You\'re exaggerating." "Forget about it."\n\nWe can say: "I\'m listening." "You did the right thing telling me." "I\'ll get help to know what to do."\n\nWe never promise a child to keep to ourselves information that could concern their safety.\n\n8. When in doubt, we speak up\n\nWe don\'t need to be certain a situation is serious to talk about it: a gesture that makes us uncomfortable, an attitude that raises questions, a child who seems afraid, unusual remarks, an adult\'s behavior that seems inappropriate to us.\n\nA doubt is worth sharing. We talk to the person in charge or the designated contact within the association. We do not try to investigate ourselves or to get the child to talk further. Our first role is to protect and to alert.\n\n9. We are all responsible\n\nProtecting children is not only the responsibility of professionals. A volunteer may see something. A facilitator may overhear a remark. A member may witness a situation. Everyone can help create a safer environment.\n\nThis also means we can talk to one another as adults when a situation raises questions for us. Reporting behavior that seems inappropriate to us is not accusing someone. It is contributing to child protection and to the proper functioning of our association.\n\n10. The spirit of our association\n\nWe want children who come through our door to leave having had a positive experience. We want them to be able to: dare to try, dare to make mistakes, dare to ask questions, dare to say no, dare to ask for help, dare to be themselves.\n\nWe want every child to meet adults who know how to set a framework while remaining attentive. Adults who share their passion, adults who encourage, adults who know how to recognize their own limits, adults children can trust.\n\nOur commitment\n\nBy being part of the association, we all help to create this environment. We commit to:\n\nRESPECTING every child and their integrity.\nLISTENING to what they say and taking their emotions seriously.\nPROTECTING their body and their privacy.\nENCOURAGING without humiliating or comparing.\nSETTING LIMITS without violence or fear.\nSTAYING VIGILANT about situations that could put a child at risk.\nSPEAKING UP when a situation raises questions for us.\nACTING when a child\'s safety or wellbeing is at stake.\n\nBecause beyond our activities, our workshops and our projects, we have an essential responsibility: to make sure every child feels respected, heard and safe.',
        },
    ),
}
...
async def register(data: RegisterIn, background: BackgroundTasks):
    ...
    if not data.charter_consent:
        raise HTTPException(status_code=400, detail="Vous devez confirmer avoir pris connaissance de la Charte de respect et de protection des enfants.")
    ...
    doc = {
        ...
        "rgpd_consent": True, "rgpd_consent_at": now_iso(),
        "charter_consent": True, "charter_consent_at": now_iso(),
        "created_at": now_iso(),
    }
